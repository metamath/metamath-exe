...
H("Note: See HELP LANGUAGE for the HTML markup syntax in comments.");
H("");
...
H("mmtheoremsall.html, mmdefinitions.html, and mmascii.html will be");
H("produced.  Thus:");
H("    SHOW STATEMENT * / HTML");
H("will output a complete HTML proof database in the current directory,");
H("one file per $a and $p statement, along with mmtheoremsall.html,");
H("mmdefinitions.html, and mmascii.html.  The statement:");
H("    SHOW STATEMENT &* / HTML");
H("will produce only mmtheoremsall.html, mmdefinitions.html, and");
H("mmascii.html, but no other HTML files (because no labels can match \"&*\"");
H("since \"&\" is illegal in a statement label).  Note added 30-Jan-06:  The");
H("mmtheoremsall.html file produced by this command is deprecated and is");
H("replaced by the output of WRITE THEOREM_LIST.");
H("");
