...
H("");
H("    Axiom, Chapter, Claim, Compare, Condition, Conjecture, Corollary,");
H("    Definition, Equation, Example, Exercise, Figure, Item, Lemma, Lemmas,");
H("    Line, Lines, Notation, Note, Observation, Part, Postulate, Problem,");
H("    Proof, Property, Proposition, Remark, Result, Rule, Scheme, Section,");
H("    Statement, Theorem");
H("");
