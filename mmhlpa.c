...
H("  LEMMON / RENUMBER, where xxx is the label of a $p statement.  To");
H("  convert a compressed proof to a sequence of labels, type");
H("  SAVE PROOF xxx / NORMAL.  To see how the substitutions are made in a");
H("  proof step, type SHOW PROOF xxx / DETAILED_STEP nnn, where nnn is a");
H("  step number from a SHOW PROOF command without the / RENUMBER qualifier.");
H("");
...
H("             be specified as \"~~\") and not a statement label (which");
